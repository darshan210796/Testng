...
public class Elementutil {
	...
	public Elementutil(WebDriver odriver) {
		this.odriver = odriver;
		jsUtil = new JavaScriptUtil(odriver);
	}

	public WebElement getElement(By locator) {
		WebElement element = odriver.findElement(locator);
		System.out.println(Initialsetup.highlight);
		if (Boolean.parseBoolean(Initialsetup.highlight)) {
	...
	public List<WebElement> getElements(By locator) {
		return odriver.findElements(locator);
	}
	...
	public WebElement waitForElementPresence(By locator, int timeOut) {
		WebDriverWait wait = new WebDriverWait(odriver, Duration.ofSeconds(timeOut));
	...
	public WebElement waitForElementPresenceWithFluentWait(int timeOut, int pollingTime, By locator) {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(odriver).withTimeout(Duration.ofSeconds(timeOut))
